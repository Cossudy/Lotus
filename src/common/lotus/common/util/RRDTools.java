...
public class RRDTools {
     ...
     * @param timeStamp
     */
    public static void addMonitorInfoPMInRRD(RrdDb rrdDb, InfoPM msg,
            long timeStamp) {
        Sample sample;
...
//                    / msg.netInfo.bandWidth);
     ...
     * @param timeStamp
     */
    public static void addMonitorInfoVMInRRD(RrdDb rrdDb, InfoVM msg,
            long timeStamp) {
